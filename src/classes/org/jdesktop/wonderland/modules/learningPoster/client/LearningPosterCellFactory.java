...
/**
 * The cell factory for the learningPostercell.<br>
 ...
 */
@CellFactory
public class LearningPosterCellFactory implements CellFactorySPI {
    ...
    public <T extends CellServerState> T getDefaultCellServerState(Properties props) {
        CellServerState state = new LearningPosterCellServerState();
        ...
        state.setName(bundle.getString("learningPoster"));
        return (T) state;
    }
