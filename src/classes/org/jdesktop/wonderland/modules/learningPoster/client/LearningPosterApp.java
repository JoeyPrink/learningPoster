...
/**
 * Class to represent the learningPoster app. 
 * @author Bernard Horan
 */
public class LearningPosterApp extends App2D {

    /**
     * Create a new instance of LearningPosterApp. This in turn creates
     ...
     */
    public LearningPosterApp(String name, Vector2f pixelScale) {
     ...
     *
     * @param name The name of the app.
     * @param control arb the control arbiter to use for the learningPoster.
     * @param pixelScale The horizontal and vertical pixel sizes (in world metres per pixel).
     */
    protected LearningPosterApp(String name, ControlArb controlArb, Vector2f pixelScale) {
