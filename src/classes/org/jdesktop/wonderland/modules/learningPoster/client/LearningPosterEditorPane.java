 ...
 */
public class LearningPosterEditorPane extends JEditorPane {
    private static final Logger LOGGER =
            Logger.getLogger(LearningPosterEditorPane.class.getName());
    
    private final Cell cell;
    
    public LearningPosterEditorPane(Cell cell) {
        this.cell = cell;
    ...
    protected HyperlinkListener createHyperlinkListener() {
        return new LearningPosterHyperlinkListener(this, cell);
    }
