 ...
 */
class learningPosterNode extends GeometryNode {

    private static final Logger logger = Logger.getLogger(learningPosterNode.class.getName());
     ...
     */
    learningPosterNode (View2D view) {
        super(view);

        quad = new TexturedQuad(null, "TexturedQuad for learningPoster Node of " + view.getName());
    ...
    private BillboardNode getBillboardNode() {
        BillboardNode bb = new BillboardNode("learningPoster billboard");
        bb.attachChild(quad);
        return bb;
    }
