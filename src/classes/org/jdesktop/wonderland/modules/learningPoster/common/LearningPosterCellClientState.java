...
/**
 * Container for learningPoster client cell client state data.
 *
 * @author Bernard Horan
 */
public class LearningPosterCellClientState extends App2DCellClientState {

    final public static String SHARED_MAP_KEY = "learningPoster";
    final public static String TEXT_LABEL_KEY = "text";
    final public static String FILE_LABEL_KEY = "actualFileName";
    ...
    public LearningPosterCellClientState() {
        this(null);
    }

    public LearningPosterCellClientState(Vector2f pixelScale) {
        super(pixelScale);
    }
